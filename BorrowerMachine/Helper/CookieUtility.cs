...
namespace BorrowerMachine.Helper
{
  public static class CookieUtility<T> where T: class
  {


    public static T UserCookie
    {
      get
      {
        ...
        if (itemCookie != null)
        {
          T userCookie = new JavaScriptSerializer().Deserialize<T>(itemCookie.Value);
          return userCookie;
        }
        else
          return null;
